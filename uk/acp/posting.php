...
$lang = array_merge($lang, array(
	...
	'ADD_BBCODE'				=> 'Додати новий код BBCode',
 	...
 	'BBCODE_DANGER'				=> 'Схоже, що BBCode, який ви намагаєтесь додати, не є безпечним. Якщо BBCode використовує лексему {TEXT} в ненадійному контексті, спробуйте використати натомість інші лексеми, більш обмеженого типу. Продовжуйте лише у випадку, якщо ви цілком розумієте можливі ризики.',
	...
	'BBCODE_INVALID_TEMPLATE'	=> 'Ваш шаблон BBCode невірний.',
	'BBCODE_TAG'				=> 'Тег',
	...
	'tokens'	=>	array(
		'TEXT'			=> 'Будь-який текст, який містить символи різних мов, цифри тощо…',
