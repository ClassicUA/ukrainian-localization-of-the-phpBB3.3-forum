...
$lang = array_merge($lang, array(
	...
	'CSV_INVALID'			=> 'Наданий параметр "%1$s", розділений комами, є недійсним. Значення повинні розділятися лише комами, вони не повинні містити ніяких попередніх або наступних роздільників.',
