...
$lang = array_merge($lang, array(
	...
	'CANNOT_REMOVE_MODULE'	=> 'Неможливо видалити модуль, який має дочірні модулі. Будь ласка, видаліть або перемістіть усі дочірні модулі перед виконанням цієї дії.',
	'CATEGORY'				=> 'Категорія',
