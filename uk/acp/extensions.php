...
$lang = array_merge($lang, array(
	...
	'EXTENSION_INSTALL_HEADLINE'=> 'Встановлення розширень',
	'EXTENSION_INSTALL_EXPLAIN'	=> '<ol>
			<li>Завантажте розширення з бази розширень phpBB</li>
			<li>Розархівуйте розширення і завантажте його в каталог <samp>ext/</samp> вашого форуму phpBB</li>
			<li>Увімкніть розширення тут в розділі "Керування розширеннями"</li>
		</ol>',
	...
	'BROWSE_EXTENSIONS_DATABASE'		=> 'Перейти в базу розширень',
