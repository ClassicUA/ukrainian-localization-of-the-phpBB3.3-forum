...
$lang = array_merge($lang, array(
	'ACP_PERMISSIONS_EXPLAIN'	=> '
		...
		<p>Для отримання більш детальної інформації по встановленню та керуванню правами доступу на вашому форумі phpBB3, перегляньте розділ <a href="https://www.phpbb.com/support/docs/en/3.3/ug/quickstart/permissions/">"Встановлення прав доступу" нашого посібника</a>.</p>
	',
	...
	'ACP_FORUM_PERMISSIONS_COPY_EXPLAIN' => 'Тут ви можете скопіювати форумні права доступу з одного форуму в інший або в декілька інших форумів.',
	...
	'TRACE_USER_GLOBAL_YES_TOTAL_YES'		=> 'Незалежно від форуму встановлене право доступу користувача - <strong>ТАК</strong>, але кінцеве значення права доступу вже встановлено в <strong>ТАК</strong>, тому збережено раніше встановлене значення. %sВідслідкувати глобальне право доступу%s',
