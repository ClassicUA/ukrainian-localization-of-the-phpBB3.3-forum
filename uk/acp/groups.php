...
$lang = array_merge($lang, array(
	...
	'GROUP_MESSAGE_LIMIT_EXPLAIN'	=> 'Це замінить загальний для користувачів ліміт повідомлень. Буде використано значення, встановлене на рівні групи користувача.<br />Встановіть 0, щоб замінити його на загальне значення, встановлене для усіх користувачів форуму.',
	...
	'GROUP_MAX_RECIPIENTS_EXPLAIN'   => 'Максимально дозволена кількість отримувачів в приватному повідомлення. Буде використано значення, встановлене на рівні групи користувача.<br />Встановіть 0, щоб замінити його на загальне значення, встановлене для усіх користувачів форуму.',
	...
	'GROUP_USERS_INVALID'			=> 'Користувачів не було додано в групу, оскільки таких імен користувачів не існує: %s',
	...
	'TEAMPAGE_FORUMS_EXPLAIN'	=> 'Якщо обрано "так", модератори будуть бачити список модерованих ними форумів. Це збільшує навантаження на базу даних на великих форумах.',
