...
$lang = array_merge($lang, array(
	...
	'BOT_AGENT_EXPLAIN'	=> 'Стрічка, яка відповідає стрічці User-Agent бота. Дозволяються часткові збіги.',
	...
	'BOT_IP_EXPLAIN'	=> 'Допускаються часткові збіги, адреси розділяйте комами.',
	'BOT_NAME'	=> 'Назва бота',
	...
	'ERR_BOT_NO_MATCHES'	=> 'Вам необхідно вказати хоча б одну стрічку User-Agent або IP для визначення бота.',
