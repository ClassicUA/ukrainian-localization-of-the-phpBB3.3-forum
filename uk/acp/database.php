...
$lang = array_merge($lang, array(
	...
	'ACP_BACKUP_EXPLAIN'	=> 'Тут ви можете зробити резервне копіювання усіх даних, пов\'язаних з phpBB. Архів резервної копії буде збережено в вашій папці <samp>store/</samp>. В залежності від конфігурації вашого сервера ви можете стиснути файл в кількох форматах.',
	...
	'BACKUP_NOT_SUPPORTED'	=> 'Обрана резервна копія не підтримується',
