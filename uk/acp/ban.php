...
$lang = array_merge($lang, array(
	...
	'30_MINS'	=> '30 хвилин',
	'6_HOURS'	=> '6 годин',
	'ACP_BAN_EXPLAIN'	=> 'Тут ви можете контролювати заборону доступу користувачам по імені, IP або e-mail адресі. Ці методи не дозволяють попасти в жоден розділ форуму. Ви можете ввести коротку (255 символів) причину заборони доступу. Це відобразиться в логах адміністраторів. Також можна встановити тривалість заборони. Якщо ви хочете встановити заборону до якоїсь певної дати замість періоду часу, оберіть <span style="text-decoration: underline;">До</span> для встановлення тривалості заборони і введіть дату в форматі рррр-мм-дд.',
	...
	'EMAIL_BAN_EXPLAIN'	=> 'При заданні декількох адрес e-mail, вводьте кожну з нової стрічки. Для часткових збігів використовуйте символ * в якості шаблону, наприклад <samp>*@hotmail.com</samp>, <samp>*@*.domain.tld</samp>, etc.',
	...
	'USER_BAN_EXPLAIN'	=> 'Ви можете заблокувати відразу декількох користувачів, ввівши кожне ім\'я з нової стрічки. Використовуйте можливість <span style="text-decoration: underline;">Знайти учасника</span> для пошуку і автоматичного додавання одного або декількох користувачів.',
