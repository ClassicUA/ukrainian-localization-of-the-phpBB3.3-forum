...
$lang = array_merge($lang, array(
	...
	'DEFAULT_DATE_FORMAT_EXPLAIN'	=> 'Формат дати ідентичний до функції PHP <code><a href="https://secure.php.net/manual/function.date.php">date()</a></code>.',
	...
	'DISPLAY_UNAPPROVED_POSTS'		=> 'Показувати несхвалені повідомлення автору',
	'DISPLAY_UNAPPROVED_POSTS_EXPLAIN'	=> 'Несхвалені повідомлення можуть переглядатись автором. Не стосується повідомлень Гостей.',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_BOARD_NOTIFICATIONS' => 'Дозволити сповіщення',
));
...
$lang = array_merge($lang, array(
	...
	'ALLOW_REMOTE_EXPLAIN'	=> 'Посилання на аватари з інших серверів.<br><em><strong class="error">Попередження:</strong> Увімкнення даної функції може дозволити користувачам робити перевірку на існування файлів і сервісів в локальній мережі.</em>',
	'ALLOW_REMOTE_UPLOAD'			=> 'Увімкнути віддалене завантаження аватарів',
	'ALLOW_REMOTE_UPLOAD_EXPLAIN'	=> 'Дозволити завантаження аватарів з інших сайтів.<br><em><strong class="error">Попередження:</strong> Увімкнення даної функції може дозволити користувачам робити перевірку на існування файлів і сервісів в локальній мережі.</em>',
...
$lang = array_merge($lang, array(
	...
	'BOXES_LIMIT'	=> 'Максимальна кількість приватних повідомлень в скриньці',
...
$lang = array_merge($lang, array(
	...
	'ALLOWED_SCHEMES_LINKS'				=> 'Дозволені протоколи в посиланнях',
	'ALLOWED_SCHEMES_LINKS_EXPLAIN'		=> 'Користувачі зможуть розміщувати посилання лише з протоколами, вказаними в даному списку через кому. В протилежному випадку можна буде розміщувати лише посилання без вказання протоколу.',
...
$lang = array_merge($lang, array(
	...
	'PASSWORD_LENGTH_EXPLAIN'	=> 'Мінімальна кількість символів в паролях. Зауважте, що максимальна кількість не обмежується',
...
$lang = array_merge($lang, array(
 	...
 	'ACP_FEED_ENABLE_EXPLAIN' => 'Вмикає або вимикає канали новин для усього форуму.<br>Вимкнення цієї опції вимикає усі канали новин, незалежно від встановлених нижче параметрів. ', 
 	'ACP_FEED_LIMIT' => 'Кількість елементів', 
 	'ACP_FEED_LIMIT_EXPLAIN' => 'Максимальна кількість елементів каналу новин для відображення.',
 	'ACP_FEED_OVERALL'	=> 'Увімкнути загальний канал',
 	...
 	'ACP_FEED_ITEM_STATISTICS_EXPLAIN' => 'Відображає індивідуальну статистику під елементами каналу<br>(наприклад, автора повідомлення, дату та час публікації, кількість відповідей та переглядів).', 
 	'ACP_FEED_EXCLUDE_ID' => 'Виключити ці форуми', 
 	'ACP_FEED_EXCLUDE_ID_EXPLAIN' => 'Вміст наступних форумів <strong>не буде включено до каналів новин</strong>. Не обирайте форумів, якщо хочете отримувати дані з усіх форумів.<br>Для скасування вибору/вибору декількох форумів, утримуйте клавішу <samp>Ctrl</samp> і натискайте клавішу миші на потрібних форумах.', 
));
 

// Visual Confirmation Settings
$lang = array_merge($lang, array(
	'ACP_VC_SETTINGS_EXPLAIN'	=> 'Тут ви можете обрати та налаштувати модулі, які розроблено для блокування автоматичного заповнення форм спам-ботами. Принцип дії цих додатків зазвичай ґрунтується на введенні користувачем символів з зображення <em>CAPTCHA</em> - завдання, яке досить складне для виконання комп\'ютерам.',
...
// Cookie Settings
$lang = array_merge($lang, array(
	'ACP_COOKIE_SETTINGS_EXPLAIN'	=> 'Ці налаштування визначають, яка інформація використовується для надсилання cookies до браузерів користувачів. В більшості випадків налаштувань за замовчуванням цілком достатньо. Якщо вам потрібно щось змінити, робіть це уважно, невірні налаштування можуть призвести до неможливості залогування користувачів. Якщо такі проблеми виникли, відвідайте сторінку <strong><a href="https://www.phpbb.com/support/go/cookie-settings">База знань phpBB.com - виправлення налаштувань cookie</a></strong>',
	'COOKIE_DOMAIN'	=> 'Домен cookie',
	'COOKIE_DOMAIN_EXPLAIN'		=> 'В більшості випадків немає необхідності вказувати домен cookie. Залиште поле порожнім, якщо ви не впевнені, яке значення потрібно вказати.<br><br>Якщо форум інтегровано з іншим програмним забезпеченням або використовується декілька доменів, налаштуйте домен cookie наступним чином. Наприклад, якщо імена доменів мають вигляд <i>example.com</i> і <i>forums.example.com</i>, або <i>forums.example.com</i> і <i>blog.example.com</i>, використовується ім\'я спільного для них домену <i>example.com</i>, перед яким додається крапка. В результаті, задане ім\'я домену cookie буде виглядати як <i>.example.com</i> (зверніть увагу на точку на початку).',
	'COOKIE_NAME'	=> 'Назва cookie',
	'COOKIE_NAME_EXPLAIN' => 'Ім\'я cookie може бути будь-яким, якомога унікальнішим. При зміні налаштувань cookie необхідно також змінити його ім\'я.',
	'COOKIE_NOTICE'				=> 'Попередження про використання cookie',
	'COOKIE_NOTICE_EXPLAIN'		=> 'Якщо увімкнено, користувачам буде відображатись попередження про використання cookie на форумі. Відображення такого попередження може вимагатись законодавством деяких країн в залежності від тематики форуму і встановлених розширень.',
	'COOKIE_PATH'	=> 'Шлях cookie',
	'COOKIE_PATH_EXPLAIN' => 'Шлях cookie завжди являє собою прямий слеш, незалежно від реального шляху до форуму.',
...
$lang = array_merge($lang, array(
	...
	'CONTACT_US_ENABLE_EXPLAIN'		=> 'Дана сторінка дозволяє користувачам відправляти електронну пошту адміністраторам форуму. Майте на увазі, що для цього повинна бути увімкненою функція електронної пошти на форумі. Ви можете її знайти в розділі Загальні &gt; Засоби зв\'язку &gt; Налаштування e-mail.',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_CDN_EXPLAIN'	=> 'Якщо дану функцію увімкнено, деякі файли форуму будуть завантажуватись з інших серверів замість вашого. Це зменшить об\'єм трафіку, який використовує ваш сервер, але в деяких країнах бути проблемою конфіденційності. У стандартній установці phpBB це включає завантаження “jQuery” та шрифту “Open Sans” з мережі доставки контенту Google. Це також стосується шрифту “Font Awesome”, який використовується phpBB та деякими додатками для відображення піктограм.',
	...
	'LOAD_USER_ACTIVITY_LIMIT' => 'Обмеження кількості повідомлень для відображення активності користувача',
	'LOAD_USER_ACTIVITY_LIMIT_EXPLAIN' => 'Теми і форуми, в яких користувач проявляє основну активність, не будуть відображені для користувачів, що мають кількість повідомлень більше зазначеного. Встановіть 0 для зняття обмеження. ',
	...
	'YES_ACCURATE_PM_BUTTON'			=> 'Увімкнути перевірку прав доступу для відображення кнопки особистого повідомлення на сторінках тем',
	'YES_ACCURATE_PM_BUTTON_EXPLAIN'	=> 'Якщо дану опцію увімкнено, кнопка особистого повідомлення в мініпрофілях на сторінках тем буде відображатись тільки для користувачів, які мають право отримувати особисті повідомлення.',
...
$lang = array_merge($lang, array(
	...
	'SERVER_NAME_EXPLAIN'	=> 'Ім\'я домену, на якому працює цей форум (наприклад: <samp>example.com</samp>).',
	'SERVER_PORT'	=> 'Порт',
...
$lang = array_merge($lang, array(
	...
	'REFERRER_VALID_EXPLAIN'	=> 'Якщо увімкнуто, реферер запитів POST буде перевірятись на параметри шляху хосту/шляху до скрипту. Це може призвести до проблем з форумами, які використовують декілька доменів або зовнішні логування.',
	...
	'UPLOAD_CERT_VALID_EXPLAIN'		=> 'Якщо увімкнено, сертифікати віддалених завантажень будуть перевірятись. Для цього необхідно визначити вбудовану бібліотеку CA в параметрах <samp>openssl.cafile</samp> або <samp>curl.cainfo</samp> в файлі php.ini.',
));
...
$lang = array_merge($lang, array(
	...
	'ADMIN_EMAIL'	=> 'Адреса відправника e-mail',
	'ADMIN_EMAIL_EXPLAIN'	=> 'Використовується як адреса відправника для усіх електронних листів, які повертаються, та як контактна адреса e-mail для зв\'язку з технічних питань. Вона завжди буде використана в якості адрес <samp>Return-Path</samp> та <samp>Sender</samp> в електронних листах.',
	...
	'EMAIL_FORCE_SENDER'			=> 'Примусово використовувати адресу відправника',
	'EMAIL_FORCE_SENDER_EXPLAIN'	=> 'Примусово використовувати поле <samp>Return-Path</samp> в якості адреси відправника email-повідомлень замість використання імен користувача і сервера. Дане налаштування не впливає при відправці повідомлень за допомогою SMTP-сервера.<br><em><strong>Застереження:</strong> потрібно додати ім\'я користувача, під яким працює вебсервер, в список довірених в конфігурації sendmail.</em>',
	...
	'EMAIL_MAX_CHUNK_SIZE'			=> 'Максимально дозволена кількість отримувачів email-повідомлень',
	'EMAIL_MAX_CHUNK_SIZE_EXPLAIN'	=> 'Максимальна кількість адресатів в одному повідомленні. Дана настройка застосовується для того, щоб не перевищити значення, максимально дозволене сервером.',
	...
	'SEND_TEST_EMAIL'				=> 'Надіслати тестове email-повідомлення',
	'SEND_TEST_EMAIL_EXPLAIN'		=> 'Буде надіслано тестове email-повідомлення на адресу, вказану в вашому обліковому записі.',
	...
	'SMTP_PASSWORD_EXPLAIN'	=> 'Вводьте пароль, лише якщо ваш SMTP-сервер його вимагає. <br><em><strong>Застереження:</strong> цей пароль зберігається в базі даних у відкритому вигляді.</em>',
	'SMTP_PLAIN'	=> 'PLAIN',
	...
	'SMTP_SERVER_EXPLAIN'	=> 'Не вказуйте протокол (<samp>ssl://</samp> чи <samp>tls://</samp>), якщо ваш поштовий сервер не вимагає цього.',
	...
	'SMTP_VERIFY_PEER'				=> 'Перевірка SSL-сертифікату',
	'SMTP_VERIFY_PEER_EXPLAIN'		=> 'Вимагати перевірку SSL-сертифікату, який використовується сервером SMTP.<br><em><strong>Застереження:</strong> підключення до ресурсів з неперевіреними SSL-сертифікатами може мати негативні наслідки з точки зору інформаційної безпеки.</em>',
	'SMTP_VERIFY_PEER_NAME'			=> 'Перевірка імені вузла SMTP',
	'SMTP_VERIFY_PEER_NAME_EXPLAIN'	=> 'Вимагати перевірку імені вузла для серверів SMTP, які використовують підключення SSL / TLS.<em><strong>Застереження:</strong> підключення до ресурсів з неперевіреними SSL-сертифікатами може мати негативні наслідки з точки зору інформаційної безпеки.</em>',
	'TEST_EMAIL_SENT'				=> 'Тестове email-повідомлення надіслано.<br>Якщо ви його не отримали, перевірте налаштування пошти.<br><br>Якщо вам необхідна допомога, зверніться на форум <a href="https://phpbb.com.ua/community/">офіційної української підтримки phpBB</a>.',
	'SMTP_ALLOW_SELF_SIGNED' => 'Дозволити самопідписані SSL сертифікати',
	'SMTP_ALLOW_SELF_SIGNED_EXPLAIN' => 'Дозволити підключення до поштових серверів SMTP з самопідписаними SSL-сертифікатами.<br><em><strong>Застереження:</strong> таке підключення може мати негативні наслідки з точки зору інформаційної безпеки.</em>',
...
$lang = array_merge($lang, array(
	...
	'JAB_ALLOW_SELF_SIGNED_EXPLAIN'	=> 'Дозволити підключення до серверів Jabber з самопідписаними SSL-сертифікатами. <br><em><strong>Застереження:</strong> таке підключення може мати негативні наслідки з точки зору інформаційної безпеки.</em>',
	...
	'JAB_USERNAME_EXPLAIN'	=> 'Вкажіть зареєстроване ім\'я користувача або правильний JID. Ім\'я користувача буде перевірено на коректність. Якщо ви вказали лише ім\'я користувача, то ваш JID буде іменем користувача та сервера, вказаними нижче. Або, вкажіть правильний JID, наприклад  user@jabber.org.',
	'JAB_VERIFY_PEER'				=> 'Перевірка SSL-сертифікату',
	'JAB_VERIFY_PEER_EXPLAIN'		=> 'Вимагати перевірку SSL-сертификату, який використовується сервером Jabber. <br><em><strong>Застереження:</strong> підключення до ресурсів з неперевіреними SSL-сертифікатами може мати негативні наслідки з точки зору інформаційної безпеки.</em>',
	'JAB_VERIFY_PEER_NAME'			=> 'Перевірка імені вузла Jabber',
	'JAB_VERIFY_PEER_NAME_EXPLAIN'	=> 'Вимагати перевірку імені вузла для серверів Jabber, які використовують підключення SSL / TLS. <br><em><strong>Застереження:</strong> підключення до ресурсів з неперевіреними SSL-сертифікатами може мати негативні наслідки з точки зору інформаційної безпеки.</em>',
));
