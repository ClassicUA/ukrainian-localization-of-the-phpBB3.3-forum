...
$lang = array_merge($lang, array(
	...
	'IMAGE_QUALITY'				=> 'Якість завантаженого файлу зображення (лише для JPEG)',
	'IMAGE_QUALITY_EXPLAIN'		=> 'Задайте значення між 50% (менший розмір файлу) і 90% (краща якість). Якість вища за 90% збільшує розмір файлу і тому вимкнена. Налаштування дозволене лише якщо максимальні розміри зображення мають значення, відмінні від 0 на 0 пікселів.',
	'IMAGE_STRIP_METADATA'		=> 'Видалення метаданих зображення (лише для JPEG)',
	'IMAGE_STRIP_METADATA_EXPLAIN'	=> 'Видалення метаданних Exif, таких як ім\'я автора, координати GPS та інформація про камеру. Налаштування застосовується лише якщо максимальні розміри зображення мають значення, відмінні від 0 на 0 пікселів.',
	...
	'NO_EXT_GROUP'				=> 'Немає',
	'NO_EXT_GROUP_ALLOWED_PM'	=> 'Відсутні <a href="%s">дозволені групи розширень</a> для приватних повідомлень.',
	'NO_EXT_GROUP_ALLOWED_POST'	=> 'Відсутні <a href="%s">дозволені групи розширень</a> для повідомлень.',
