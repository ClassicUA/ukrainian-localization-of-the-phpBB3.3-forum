...
$lang = array_merge($lang, array(
	...
	'FORUM_DESC'						=> 'Опис',
	'FORUM_DESC_EXPLAIN'				=> 'Будь-яка розмітка HTML, введена тут, буде відображатись в тому ж вигляді. Якщо обрано тип форуму "Категорія", опис не буде відображено.',
	...
	'FORUM_NAME_EMOJI'					=> 'Введено невірну назву форуму.<br>Вона містить наступні непідтримувані символи:<br>%s',
	...
	'LINK'					=> 'Посилання',
	'LIMIT_SUBFORUMS'			=> 'Показувати в списку тільки підфоруми',
	'LIMIT_SUBFORUMS_EXPLAIN'	=> 'Обмежує список підфорумів тільки тими, для яких даний форум є батьківським безпосередньо (першого рівня вкладеності). При вимкненні даної опції в списку буде відображено всі підфоруми даного форуму (незалежно від рівня вкладеності), для яких увімкнено "Показувати форум в списку подфорумів".',
