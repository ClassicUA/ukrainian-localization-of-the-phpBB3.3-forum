...
$lang = array_merge($lang, array(
	...
	'PRIVACY_POLICY'	=> 'Ця політика детально пояснює, як “%1$s” і його підрозділи (надалі “ми”, “наш”, “%1$s”, “%2$s”) і phpBB (надалі “вони”, “їх”, “їхнє”, “Програмне забезпечення phpBB”, “www.phpbb.com”, “phpBB Group”, “phpBB Teams”) використовують інформацію, отриману під час будь-якої вашої сесії (надалі “інформація про вас”).
	<br><br>
...
$lang = array_merge($lang, array(
	...
	'EMAIL_REMIND'	=> 'Це має бути адреса електронної пошти, пов\'язана з вашим обліковим записом. Якщо ви не змінили її через панель керування, то це адреса електронної пошти, на яку ви зареєстрували свій обліковий запис.',
	...
	'NOTIFICATION_TYPE_FORUM'							=> 'Хтось відповів у темі форуму, на який ви підписані',
	...
	'NOTIFICATION_TYPE_REPORT_CLOSED'					=> 'Вашу скаргу на допис закрито модератором',
	'NOTIFICATION_TYPE_REPORT_PM'						=> 'Хтось поскаржився на приватне повідомлення',
	'NOTIFICATION_TYPE_REPORT_PM_CLOSED'				=> 'Вашу скаргу на приватне повідомлення закрито модератором',
